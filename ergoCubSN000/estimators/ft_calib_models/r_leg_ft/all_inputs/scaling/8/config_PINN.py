...
n_neurons = 100 #435 #1445 # 500 #1100 #1200 #1100 #850 #750 #500                       
...
weight_expected = 1                   # weight of expected sum of wrenches in the loss function
...
Scheduler = False                        # True if you wanna the scheduler to decrease learning rate during the training
